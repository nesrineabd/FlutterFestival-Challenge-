    ...
    scrollController = ScrollController()
      ..addListener(() {
        if (scrollController.offset >= headerImageSize / 2) {
          if (!bodyScrollAnimationController
              .isCompleted) bodyScrollAnimationController.forward();
        } else {
          if (bodyScrollAnimationController
              .isCompleted) bodyScrollAnimationController.reverse();
        }
      });

    appBarSlide = Tween<double>(begin: 0, end: 1).animate(
        CurvedAnimation(
    ...
    return Row(
      children: <Widget>[
        ...
        Column(
          ...
          children: <Widget>[
            Text(
                DateTimeUtils.getDayOfWeek(event.eventDate), style: titleStyle),
        ...
        Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              Text("Add To Calendar", style: subtitleStyle.copyWith(color: Theme
                  .of(context)
                  .primaryColor)),
  ...
  Widget buildOrganizeInfo() {
    return Row(
      children: <Widget>[
        ...
        const Spacer(),
        TextButton(
          child: Text("Follow", style: TextStyle(color: Theme
              .of(context)
              .primaryColor)),
          onPressed: () {},
              ...
              RichText(
                text: TextSpan(
                  children: [
                    ...
                    const TextSpan(text: "/per person",
